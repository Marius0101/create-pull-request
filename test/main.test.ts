...
describe('main run function', ()=>{
    ...
    it("Should create pull request when inputs does not contain any assignees or reviewers", async ()=> {
        ...
        expect(core.info).toHaveBeenNthCalledWith(1,"No users assigned to this pull request!");
        expect(core.info).toHaveBeenNthCalledWith(2,"No reviewers added to this pull request!");
    });
    ...
    it("Should assign users when assignees are added", async () =>
    {
        ...
        expect(common.addReviewersToPR).not.toHaveBeenCalled();
        expect(core.info).not.toBeCalledWith("No users assigned to this pull request!");
        expect(core.info).toHaveBeenNthCalledWith(1,"No reviewers added to this pull request!");
    });
    it("Should assign users when assignees are added", async () =>
    {
        //Arrange
    ...
    it("Should assign reviewers when user reviewers are added", async () =>
    {
        ...
        expect(core.info).toHaveBeenNthCalledWith(1, "No users assigned to this pull request!");
        expect(core.info).not.toBeCalledWith("No reviewers added to this pull request!");
    });
